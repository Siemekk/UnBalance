...
class oCGame {
    var int _vtbl;//0
    var int _zCSession_csMan;        //zCCSManager*4
    var int _zCSession_world;        //zCWorld*8
    var int _zCSession_camera;       //zCCamera*12
    var int _zCSession_aiCam;        //zCAICamera*16
    var int _zCSession_camVob;       //zCVob* 20
    var int _zCSession_viewport;     //zCView* 24

    var int cliprange;              //zREAL 28
    var int fogrange;               //zREAL 32
    var int inScriptStartup;        //zBOOL 36
    var int inLoadSaveGame;         //zBOOL 40
    var int inLevelChange;          //zBOOL 44
    ...
    var int array_view[GAME_VIEW_MAX];          //zCView* 48
    var int array_view_visible[GAME_VIEW_MAX];  //zBOOL 52
    var int array_view_enabled[GAME_VIEW_MAX];  //zBOOL 56
