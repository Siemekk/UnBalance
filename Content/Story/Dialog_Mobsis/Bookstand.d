...
func void use_finaldragonequipment_s1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		else if(hero.guild == GIL_PAL)
		{
			...
			Doc_PrintLine(ndocid,1,"");
			Doc_PrintLines(ndocid,1,"Jestem prawie pewien, ¿e paladyni wykorzystywali ³zy Innosa w dawno zapomnianym rytuale znanym jako Konsekracja Miecza. Za pomoc¹ znalezionej wczeœniej ma³ej buteleczki powinienem wiêc nadaæ konsekrowanej broni dodatkow¹ moc.(Jeœli paladyn w³ada tarcz¹, to musi tak¿e posiadaæ tarczê któr¹ otrzymuje ka¿dy paladyn, inaczej konsekracja nie ma szans na powiedzenie siê!)");
			Doc_PrintLine(ndocid,1,"");
			Doc_Show(ndocid);
		}
		else
