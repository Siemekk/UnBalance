...
func void pc_prayshrine_pray_info()
{
	...
	else
	{
		...
		{
			Info_AddChoice(pc_prayshrine_pray,"Chcê siê pomodliæ i z³o¿yæ ofiarê 100 sztuk z³ota.",pc_prayshrine_pray_smallpay);
		};
		if(Npc_HasItems(hero,itmi_gold) >= 200)
		{
			Info_AddChoice(pc_prayshrine_pray,"Chcê siê pomodliæ i z³o¿yæ ofiarê 200 sztuk z³ota.",pc_prayshrine_pray_mediumpay);
		};
		if(Npc_HasItems(hero,itmi_gold) >= 300)
		{
			Info_AddChoice(pc_prayshrine_pray,"Chcê siê pomodliæ i z³o¿yæ ofiarê 300 sztuk z³ota.",pc_prayshrine_pray_bigpay);
		};
	};
};
