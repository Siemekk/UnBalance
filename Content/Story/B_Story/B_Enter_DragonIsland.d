...
func void startup_newworld_part_dragon_undead_01()
{
	...
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_01");	
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_02");	
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_03");	
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_04");	
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_05");	
	Wld_InsertNpc 	(SKELETON_Paladin, 	"DI_ARCHOL_SKELETON_06");	
	
	Wld_InsertNpc	(DMT_DementorAmbient,	"DI_DRACONIANAREA_53");
	Wld_InsertNpc	(DMT_DementorAmbient,	"DI_DRACONIANAREA_52");
	Wld_InsertNpc	(Skeleton_Lord,		"DI_DRACONIANAREA_55");
	Wld_InsertNpc	(Skeleton_Lord,		"DI_DRACONIANAREA_55");
	Wld_InsertNpc	(Skeleton,				"DI_DRACONIANAREA_56");
	Wld_InsertNpc	(Skeleton_Lord,		"DI_DRACONIANAREA_56");
	Wld_InsertNpc	(Skeleton,				"DI_DRACONIANAREA_51");
	Wld_InsertNpc	(Skeleton_Lord,		"DI_DRACONIANAREA_51");
	Wld_InsertNpc	(Skeleton,				"DI_DRACONIANAREA_51");
...
//	PlayVideo("SHIP.BIK");
	...
	Log_AddEntry(TOPIC_HALLENVONIRDORATH,"Dotarlimy do wyspy wroga. Jeden Innos wie, co mnie czeka we wnêtrzu tej góry.");
