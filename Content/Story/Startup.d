func void Tick125Function()
{
	Add_Attributes_Varriables();	
	if(HeroInOutWorld())
	{
...
func void Difficult_Select()
{
	var int Inited_NewGame;

		if(!Inited_NewGame)
		{
			if(Hlp_StrCmp(Mem_GetGothOpt("GAME","difficulty"), "0"))
			{
			HP_Per_Level 	= 15;
			NPC_MINIMAL_DAMAGE 	= 	1;
			Hero_Minimal_Dmg			= 15;
			XP_PER_VICTORY				= 15;
			}
			...
			XP_PER_VICTORY				= 10;
			HP_Per_Level					= 10;
			NPC_MINIMAL_DAMAGE 	= 10;
			Hero_Minimal_Dmg 			=10;
			}
			else if(Hlp_StrCmp(Mem_GetGothOpt("GAME","difficulty"), "2"))
			{
			NPC_MINIMAL_DAMAGE 	=	 25;
			HP_Per_Level	=	5;
			Hero_Minimal_Dmg 			= 10; 
			XP_PER_VICTORY = 9;
		//	NewAttributes	= TRUE; //Faituge, hungry etc..
			};
		Inited_NewGame = TRUE;		
	};
};
...
func void init_global()
{
	MEM_InitAll ();
	Game_InitGerman();
	ATR_EDGEDEFENSE = hero.protection[PROT_EDGE];
	Npc_SetTalentSkill(hero,NPC_TALENT_EDGEDEFENSE,ATR_EDGEDEFENSE);
	...
	PerFrame_Init();
	FF_ApplyOnceExt(Tick125Function,125,-1);
	ReInit_Menu();
	InitDamage();
	SkyController_Ptr = 0;
	Difficult_Select();
...
func void startup_addon_part_adanostemple_01()
{
	...
	Wld_InsertNpc(STONEGUARDIAN_Boss,"ADW_ADANOSTEMPEL_ENTRANCE_12");
...
func void startup_addon_part_canyon_01()
{
	...
	Wld_InsertNpc(BLOODHOUND_Boss,"ADW_CANYON_PATH_TO_BANDITS_31");
...
func void startup_addon_part_banditscamp_01()
{
	...
	Wld_InsertNpc(BLATTCRAWLER_Boss,"ADW_CANYON_PATH_TO_BANDITS_06G");
...
func void startup_addon_part_piratescamp_01()
{
	...
	Wld_InsertNpc(ALIGATOR_Boss,"ADW_PIRATECAMP_INSEL_01");
...
func void startup_addon_part_valley_01()
{
	...
	Wld_InsertNpc(Gobbo_Shaman,"ADW_VALLEY_PATH_058_CAVE_09");
	...
	Wld_InsertNpc(STONEPUMA_Boss,"ADW_VALLEY_PATH_129_B");
...
func void startup_surface()
{
	...
	Wld_InsertNpc(SWAMPSHARK_Boss,"OW_DRAGONSWAMP_005");
	...
	Wld_InsertNpc(ICEGOLEM_BOSS,"FP_ROAM_OW_ICEREGION_7_01");
	...
	Wld_InsertNpc(ICEWOLF_Boss,"FP_ROAM_OW_ICEREGION_15_01");
	...
	Wld_InsertNpc(FIREGOLEM_Boss,"OW_PATH_012");
...
func void startup_newworld_part_xardas_01()
{
	...
	Wld_InsertNpc(XARDAS_SKEL_CLEANER,"NW_XARDAS_TOWER_IN1_11_C");
	...
	Wld_InsertNpc(Gobbo_Shaman,"NW_XAR_PATH_NF_02_TO_GC03");
...
Wld_InsertItem 	(ItWr_ManaStonePlate1_Addon, "FP_ITEM_GREATPEASANT_FERNANDOSWEAPONS_01");
	...
	Wld_InsertNpc(GIANT_BUG_Boss,"NW_FARM3_PATH_11_SMALLRIVERMID_03");
	...
	Wld_InsertNpc(Wolf_Boss,"NW_TROLLAREA_RITUALPATH_02");
	...
	Wld_InsertNpc(Troll_Boss,"NW_CASTLEMINE_TROLL_07");
	...
	Wld_InsertNpc(Gobbo_Shaman,"FP_ROAM_BIGFARM_LAKE_CAVE_10");
	...
	Wld_InsertNpc(Gobbo_Shaman,"NW_OF_GOBBOCAVE_09");
	...
	Wld_InsertNpc(lurker_boss,"NW_FARM3_MOUNTAINLAKE_MONSTER_01");
...
func void startup_newworld_part_forest_01()
{
	...
	Wld_InsertNpc(WARG_Boss,"NW_FOREST_PATH_32");
	...
	Wld_InsertNpc(WARAN_Boss,"FP_ROAM_CITY_TO_FOREST_32");
	...
	Wld_InsertNpc(waran,"NW_FOREST_PATH_82");
	Wld_InsertNpc(KEILER_Boss,"NW_FOREST_PATH_82_M");
...
{
Wld_InsertNpc(GOBBO_WARRIORS_Boss,"NW_TROLLAREA_PATH_01_02");
...
Wld_InsertItem 	(ItWr_HitPointStonePlate3_Addon, 	"FP_ROAM_NW_TROLLAREA_RIVERSIDECAVE_01_03");
	...
	Wld_InsertNpc(SNAPPER_Boss,"FP_ROAM_NW_TROLLAREA_RUINS_09");
...
func void startup_newworld()
{
	...
	KAPITEL = 1;
	//PlayVideo("INTRO.BIK"); //Odkomentować
	//PlayVideo("Addon_Title.BIK"); //Odkomentować
	Stamina_Max=50;
	Stamina=50;
	HERO_HACKCHANCE = 10;
	LP_PER_LEVEL=10;
	Talent_FASTLEARN="Nie";
	Talent_Shield_Menu="Nie";
	Talent_Dual_Menu="Nie";
	Regenerate_Mana_Skill_Menu="Nie";
	Regenerate_HP_Skill_Menu="Nie";
	/**********************************/
