...
const string LOGTEXT_ADDON_ARMOR_1 = "Nauczy³em siê tworzyæ proste pancerze, by wyrabiaæ wy¿szej jakoœci zbroje muszê pierw podnieœæ swe umiejêtnoœci.";
const string LOGTEXT_ADDON_ARMOR_2 = "Teraz potrafiê wytwarzaæ z³o¿one pancerze. Wci¹¿ powinienem æwiczyæ i podnosiæ swe umiejêtnoœci.";
const string LOGTEXT_ADDON_ARMOR_3 = "Osi¹gn¹³em mistrzowsk¹ znajomoœæ wykuwania pancerzy.";
const string LOGTEXT_ADDON_ORE_1 = "Pozna³em podstawy górnictwa i wiem jak skuteczniej kopaæ.";
const string LOGTEXT_ADDON_ORE_2 = "Moja umiejêtnoœæ górnictwa wzros³a i wiem jak kopaæ jeszcze lepiej.";
const string LOGTEXT_ADDON_ORE_3 = "O górnictwie wiem ju¿ chyba wszystko. Potrafiê kopaæ najefektywniej jak tylko siê da.";
const string LOGTEXT_ADDON_LEATHER = "Potrafiê teraz obrabiaæ pozyskane skóry.";
