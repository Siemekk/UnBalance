...
func void usepassierschein()
{
	...
	Doc_PrintLine(ndocid,0,"");
	Doc_SetFont(ndocid,0,FONT_BOOK);
	Doc_PrintLines(ndocid,0,"Ten dokument uprawnia jego posiadacza do swobodnego poruszania siê po dolnej czêœci Khorinis przez czas nieograniczony.");
	Doc_PrintLine(ndocid,0,"");
...
instance ITWR_TELEPORT_ACTIVATE(C_ITEM)
{
	...
	scemename = "MAP";
	description = "Zwój";
	Text[0]="Dziêki temu zaklêciu,";
	Text[1]="mogê aktywowaæ antyczne Kamienie Druidów.";
};

instance ITMI_RUNESTONE(C_ITEM)
{
	name = "Runiczny kamieñ";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI;
	value = 500;
...
instance ITWR_OrcWeapons1(C_ITEM)
{
	...
	Text[1]="który zosta³ najemnikiem orków i postanowi³";
	Text[2]="opisaæ styl walki orkow¹ broni¹ której siê nauczy³.";
};
...
func void Use_WritteOrcWeapons1()
{
	...
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0," Orkowe bronie czêœæ I");
	Doc_PrintLine(ndocid,0,"");
	Doc_SetFont(ndocid,0,FONT_BOOK);
	Doc_PrintLine(ndocid,0," Orkowie s¹ to istoty które kultur¹ dorównuj¹ ludziom.");
	Doc_PrintLine(ndocid,0," Jednak ró¿ni¹ siê stylem walki.  ");
	Doc_PrintLine(ndocid,0,"Orkowie atakuj¹ ciê¿kimi toporami, zaœ ludzie staraj¹ siê tworzyæ taktyki.");
	Doc_PrintLine(ndocid,0," Jako i¿ uda³o mi siê zyskaæ ich szacunek postanowi³em nauczyæ siê walczyæ ich broñmi.");
	Doc_PrintLine(ndocid,0," Uda³o mi siê stworzyæ taktykê na ich broñ!");
	Doc_PrintLine(ndocid,0," Nale¿y chwyciæ broñ tak, aby mieæ j¹ w prawej rêce i tó¿ nad g³ow¹(na prawym barku).");
	Doc_PrintLine(ndocid,0," Aby wyprowadziæ cios u¿yj silnego ruchu, dziêki temu bêdziesz móg³ uderzyæ drugi raz, ");
		Doc_PrintLine(ndocid,0," tym razem z podskokiem");

	Doc_PrintLine(ndocid,0," a na koñcu zaatakowaæ szybkim ciosem.");
	Doc_PrintLine(ndocid,0," Kolejne ataki, wyprowadzaj tak samo jak poprzednie - Wykorzystuj swoj¹ si³ê!");
...
func void Use_WritteOrcWeapons2()
{
	...
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0," Orkowe bronie czêœæ II");
	Doc_PrintLine(ndocid,0,"");
	Doc_SetFont(ndocid,0,FONT_BOOK);
	Doc_PrintLine(ndocid,0,"Bardzo s³abp czytelne pismo ");
	Doc_PrintLine(ndocid,0,"Ktoœ pisa³ to w poœpiechu");
	Doc_PrintLine(ndocid,0," ");
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0," ");
	Doc_PrintLine(ndocid,0," ");
	...
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0," ");
	Doc_PrintLine(ndocid,0,"Cholera Hosh-Pak dowiedzia³ siê o moich zapiskach, muszê uciekaæ najlepiej do zamku.");
	Doc_PrintLine(ndocid,0,"     Olgerd van Erhan");
	Doc_PrintLine(ndocid,0,"");
	Doc_SetMargins(ndocid,-1,200,50,50,50,1);
	Doc_Show(ndocid);
