...
instance ITMI_FIRSTBLADE_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia broni <<prosty miecz>>";
	text[5] = NAME_VALUE;
	count[5] = value;
...
instance ITMI_1HFINESWORD_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<dobry miecz>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_SOT_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<miecz prawdy>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_FINEBASTARD_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<dobry miecz pó³torarêczny>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_ANDURIL_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<wspania³y miecz pó³torarêczny>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_FIRSTBLADE2H_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<prosty miecz dwurêczny>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_2HFINESWORD_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<dobry miecz dwurêczny>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_CLAYMORE_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<Claymore>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_DEMONSLAYER_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<Pogromca Demonów>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
...
instance ITMI_FLAMEBERGE_BLADE(C_ITEM)
{
	...
	material = MAT_STONE;
	description = name;
	text[2] = "Mo¿e pos³u¿yæ do wykucia stalowej broni <<Flamberg>>";
	text[5] = NAME_VALUE;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_BLADE_STANDARD;
	inv_rotz = INVCAM_Z_BLADE_STANDARD;
