...
if(Npc_IsPlayer(self)){
	if(HeroKnowOrcsWeapons==1)
	{
		...
		Print("Nie potrafisz pos³ugiwaæ siê tym typem broni");
		};
	};
};
...
{
	name = "Magiczny miecz dwurêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_SPECIAL_2H_1;
...
{
	name = "Magiczny miecz pó³torarêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_SPECIAL_1H_2;
...
{
	name = "Ciê¿ki magiczny miecz dwurêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_SPECIAL_2H_2;
...
{
	name = "Ciê¿kie magiczne ostrze bojowe (niezaostrzone)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_SPECIAL_2H_3;
...
{
	name = "Dobry miecz dwurêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_2HFINESWORD;
...
{
	name = "Pogromca demonów (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_DEMONSLAYER;
...
{
	name = "Prosty miecz dwurêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_2HD_SWD;
	material = MAT_METAL;
	value = VALUE_FIRSTBLADE2H;
...
instance ITMW_GLAMDRING(C_ITEM)
{
	...
	text[4] = NAME_ADDON_BONUS_1H;
	count[4] = WAFFENBONUS_10;
	text[5] = "Zwiêksza manê o 30.                                    cena -";
	count[5] = value;
};
...
{
	name = "Wspania³y miecz pó³torarêczny";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_ANDURIL;
...
{
	name = "Wspania³y miecz pó³torarêczny (ulepszony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_ANDURIL;
...
{
	name = "Wspania³y miecz pó³torarêczny (ulepszony x2)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_ANDURIL;
...
{
	name = "Wspania³y miecz pó³torarêczny (ulepszony x3)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_ANDURIL;
...
{
	name = "Wspania³y miecz pó³torarêczny (niezaostrzony)";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_ANDURIL;
...
instance ITMW_URIZIEL(C_ITEM)
{
	...
	description			= 	name;
	TEXT[0]				=	"Potê¿ne ostrze, które jest zdobione prastarymi runami !";
	TEXT[1]				= 	"Kamieñ u podstawy klingi emanuje piêknym œwiat³em !";
